  ...
  return (
    <>
      ...
      <div className="RF flex flex-col justify-center items-center p-6 ">
        ...
        <div className="info flex flex-col md:flex-row items-center md:items-start text-left">
          <div className="text max-w-md md:w-1/2 p-4">
            <h3 className="text-lg md:text-xl">
              EV retrofitting converts gasoline vehicles into electric ones by
              replacing engines with electric motors and adding batteries,
              extending lifespan, reducing emissions, and promoting
              sustainability. It preserves classic car charm while embracing
              modern eco-tech, offering a cost-effective alternative to buying
          ...
          <div className="img mt-4 md:mt-0 md:ml-6 w-full md:w-1/2">
            <img
              src={conversion}
              alt="EV Conversion"
              className="rounded-lg shadow-lg border-4 border-green-300"
            />
          </div>
        </div>
      </div>
      ...
      <div className="service md:p-20 p-10 bg-black">
        <div className="title text-4xl my-10 md:text-6xl font-bold ">
          <h1>Our Services</h1>
        </div>
        <div className="info">
          <h3 className="text-lg md:text-xl mb-10 ">
            EV offers verioius services to its clients including{" "}
          ...
          <Link to="/services">
            <h3 className=" bg-green-700 md:text-3xl inline-block p-4 text-xl">
              See all Services
            </h3>
          </Link>
        </div>
